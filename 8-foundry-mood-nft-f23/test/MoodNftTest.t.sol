...
contract MoodNftTest is Test {
    ...
    function testTokenURIDefaultIsCorrectlySet() public {
        ...
        // console.log("**@ nft 0 , tokenURI is , ");
        // console.logBytes32(keccak256(abi.encodePacked(moodNft.tokenURI(0))));
        // console.log("**@ nft 0 ,HAPPY_MOOD_URI is , ");
        // console.logBytes32(keccak256(abi.encodePacked(HAPPY_MOOD_URI)));
